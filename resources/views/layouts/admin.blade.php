            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="{{ route("admin.pengguna.index") }}">Pengguna Baru Telah Terdaftar</a>
                  <a class="dropdown-item" href="{{ route("admin.jalan.index") }}">Pengaduan Kerusakan Jalan Baru</a>
                  <a class="dropdown-item" href="{{ route("admin.jembatan.index") }}">Pengaduan Kerusakan Jembatan Baru</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  ...
                  <a class="dropdown-item" href="{{ route("admin.users.index") }}">Settings</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#" class="nav-link" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">Log out</a>
                </div>
              </li>
            </ul>
